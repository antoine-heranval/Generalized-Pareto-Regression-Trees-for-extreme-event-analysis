...
from_learning_model_to_metrics_2=function(){
  ...
  for(learning_method in list_method){
    for(n in list_n){
        ...
        write.csv2(perf_gamma,paste0("./MSE_GAMMA_1_exp_",learning_method,"_design","_n_data",n,"_N_exp_",nb_experience,"_start_exp_",start_experience,"_burr.csv"))
        write.csv2(perf_sigma,paste0("./MSE_SIGMA_1_exp_",learning_method,"_design","_n_data",n,"_N_exp_",nb_experience,"_start_exp_",start_experience,"_burr.csv"))
